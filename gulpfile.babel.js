...
gulp.task('build.bundle.sfx', () => {
  ...
  return builder.buildStatic('farel/farel', 'dist/farel/bundles/farel.sfx.js', { runtime: false, format: 'cjs', sourceMaps: true })
});

gulp.task('build.bundle.sfx.min', () => {
  let builder = new Builder('dist', bundleConfig);

  return builder.buildStatic('farel/farel', 'dist/farel/bundles/farel.sfx.min.js', { runtime: false, format: 'cjs', sourceMaps: true, minify: true })
});
